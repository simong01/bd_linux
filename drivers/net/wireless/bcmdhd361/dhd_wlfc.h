...
#if defined(BCMDBUS)
typedef int (*f_commitpkt_t)(dhd_pub_t *dhdp, void* p);
#else
...
#define WLFC_FLOWCONTROL_STOPORPHON		384
#define WLFC_FLOWCONTROL_STOPORPHOFF	256
#else
#define WLFC_FLOWCONTROL_HIWATER	((4096 * 8) - 256)
#define WLFC_FLOWCONTROL_LOWATER	256
#define WLFC_FLOWCONTROL_STOPORPHON		((4096 * 4) - 256)
#define WLFC_FLOWCONTROL_STOPORPHOFF	((4096 * 2) - 256)
#endif
...
#define WLFC_FLOWCONTROL_LOWATER	(WLFC_FLOWCONTROL_HIWATER / 4)
#undef WLFC_FLOWCONTROL_STOPORPHON
#define WLFC_FLOWCONTROL_STOPORPHON		(WLFC_FLOWCONTROL_HIWATER / 2)
#undef WLFC_FLOWCONTROL_STOPORPHOFF
#define WLFC_FLOWCONTROL_STOPORPHOFF	(WLFC_FLOWCONTROL_HIWATER / 4)
#endif
