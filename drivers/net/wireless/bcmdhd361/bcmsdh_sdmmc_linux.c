...
MODULE_PARM_DESC(clockoverride, "SDIO card clock override (def: 0)");
...
static int bcmsdh_sdmmc_probe_ret = 0;
                              ...
                              const struct sdio_device_id *id)
{
	...
	/* Func 3 will be probed in bcmbtsdio */
...
static const struct sdio_device_id bcmsdh_sdmmc_ids[] = {
	...
	{ SDIO_DEVICE(SDIO_VENDOR_ID_SYNAPTICS, BCM43710_CHIP_ID) },
	{ SDIO_DEVICE(SDIO_VENDOR_ID_SYNAPTICS, BCM4612_CHIP_ID) },
	{ SDIO_DEVICE(SDIO_VENDOR_ID_SYNAPTICS, BCM4611_CHIP_ID) },
	{ SDIO_DEVICE(SDIO_VENDOR_ID_SYNAPTICS, BCM5312_CHIP_ID) },
	{ SDIO_DEVICE(SDIO_VENDOR_ID_SYNAPTICS, SDIO_ANY_ID) },
...
int bcmsdh_register_client_driver(void)
{
	...
	// try to get back the probe result
	ret = sdio_register_driver(&bcmsdh_sdmmc_driver);

	return ret ? ret : bcmsdh_sdmmc_probe_ret;
}
