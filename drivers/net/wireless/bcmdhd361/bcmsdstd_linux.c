...
static void
sdstd_3_tuning_timer(void *data);
...
#endif // BCMDMA64OSL
	return (uint32 *)REG_MAP(address, size);
}
...
MODULE_PARM_DESC(sd_pci_slot, "For detection to a particular PCI slot only (def: -1, unused)");
