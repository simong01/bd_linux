...
typedef struct dhd_info {
	...
	*/
	...
	char sig_path[PATH_MAX];	/* path to signature file */
	char boot_path[PATH_MAX];	/* path to boot */
	uint32 otp_addr;		/* otp address */
...
#ifndef CUSTOM_PCIE_IRQ_CPUCORE
#define CUSTOM_PCIE_IRQ_CPUCORE	0
#endif /* CUSTOM_PCIE_IRQ_CPUCORE */
 ...
 */
	...
	defined(CONFIG_SOC_EXYNOS3830) || ((defined(CONFIG_ARCH_MSM) || \
	defined(CONFIG_ARCH_QCOM)) && (((LINUX_VERSION_CODE >= KERNEL_VERSION(4, 14, 170)) && \
	(LINUX_VERSION_CODE <  KERNEL_VERSION(4, 15, 0))) || \
	(LINUX_VERSION_CODE >= KERNEL_VERSION(4, 19, 110)) || \
	(LINUX_VERSION_CODE >= KERNEL_VERSION(4, 19, 146)))))
#ifndef WAKELOCK_BACKPORT
