...
// make IOCTL wait more time especially DEBUG mode has a lot of FW log output
#ifdef DHD_DEBUG
#define DEFAULT_IOCTL_RESP_TIMEOUT	(60 * 1000)
#else // DHD_DEBUG
...
#if defined(BCMQT_HW)
#define MFG_IOCTL_RESP_TIMEOUT  (600 * 1000)  /* In milli second default value for MFG FW */
#elif defined(BCMFPGA_HW)
#define MFG_IOCTL_RESP_TIMEOUT  (60 * 1000)  /* In milli second default value for MFG FW */
#else
#define MFG_IOCTL_RESP_TIMEOUT  (20 * 1000)  /* In milli second default value for MFG FW */
#endif /* BCMQT */
...
#else /* BCMPCIE */
#define dhd_prot_send_host_timestamp(dhdp, tlv, tlv_len, seq, xt_id)    0
#define dhd_prot_data_path_tx_timestamp_logging(dhd, enable, set)       0
#define dhd_prot_data_path_rx_timestamp_logging(dhd, enable, set)       0
#define dhd_prot_pkt_noretry(dhd, enable, set)                          0
#define dhd_prot_pkt_noaggr(dhd, enable, set)                           0
#define dhd_prot_pkt_fixed_rate(dhd, enable, set)                       0
#define dhd_msgbuf_delay_post_ts_bufs(dhd)                              { UNUSED_PARAMETER(dhd); }
#endif /* BCMPCIE */
