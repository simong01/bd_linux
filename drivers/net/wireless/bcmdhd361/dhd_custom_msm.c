...
#ifdef CUSTOMER_HW2
#define WIFI_WL_REG_ON_PROPNAME        "WLPCIE_REG_ON"
...
extern void wifi_card_detect(bool device_present ,bool power_up_status) __attribute__((weak));
...
dhd_wlan_power(int onoff)
{
	...
	if (onoff) {
		...
		/***********************************************************************/
#if defined(BCMPCIE)
	DHD_ERROR(("%s: Call msm_pcie_enumerate\n", __FUNCTION__));
