...
extern int dhd_bus_download_firmware(struct dhd_bus *bus, osl_t *osh, char *fw_path,
                                     char *nv_path, char *sig_path, char *boot_path,
                                     uint32 otp_addr, char *clm_path);
...
extern int dhd_bus_console_dump(struct dhd_bus *bus);
...
#else
static INLINE void dhd_bus_dump_console_buffer(struct dhd_bus *bus)  { }
