/*
 * Definitions for Jtag taps in HND chips.
 *
...
#define LV_IR_SIZE_128		128
#define LV_DR_SIZE_128		128
...
#define LV_38_REG_IR(reg)	(LV_38_BASE | (((reg) << LV_38_REG_SHIFT) & LV_38_REG_MASK))
#define LV_38_REG_ROIR(reg)	\
	(LV_38_BASE | LV_38_RO | (((reg) << LV_38_REG_SHIFT) & LV_38_REG_MASK))
#define LV_38_UREG_IR(reg)	\
	(LV_38_BASE | ((((reg) + LV_USER_BASE) << LV_38_REG_SHIFT) & LV_38_REG_MASK))
#define LV_38_UREG_ROIR(reg)	\
	(LV_38_BASE | LV_38_RO | ((((reg) + LV_USER_BASE) << LV_38_REG_SHIFT) & LV_38_REG_MASK))
...
#define NS_DEVID47080		0x0050B17F		/* 4708C0 */
#define NS_DEVID47094		0x004FF17F		/* 4709C0 */
