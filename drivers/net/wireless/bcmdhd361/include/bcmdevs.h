...
#define BCM43710_CHIP_ID	0xAABE          /* 43710 chipcommon chipid */
#define BCM4612_CHIP_ID		0x4612          /* 4612 chipcommon chipid */
#define BCM4611_CHIP_ID		0x4611          /* 4611 chipcommon chipid */
#define BCM5312_CHIP_ID		0x5312          /* 5312 chipcommon chipid */
#define BCM4369_CHIP_ID		0x4369          /* 4369 chipcommon chipid */
...
#define BCM4362_CHIP(chipid)	((CHIPID(chipid) == BCM4362_CHIP_ID) || \
				...
				(CHIPID(chipid) == BCM43756_CHIP_ID))
...
#define BCM43710_CHIP(chipid)	(CHIPID(chipid) == BCM43710_CHIP_ID)

#define BCM43711_CHIP_GRPID	BCM43711_CHIP_ID
#define BCM43710_CHIP_GRPID	BCM43710_CHIP_ID

#define BCM4612_CHIP(chipid)	(CHIPID(chipid) == BCM4612_CHIP_ID)
#define BCM4612_CHIP_GRPID	BCM4612_CHIP_ID

#define BCM5312_CHIP(chipid)	(CHIPID(chipid) == BCM5312_CHIP_ID)
#define BCM5312_CHIP_GRPID	BCM5312_CHIP_ID
