...
#if defined(DHD_IOTLTPUT_TUNABLES)
#define H2DRING_TXPOST_MAX_ITEM			32
#else
#define H2DRING_TXPOST_MAX_ITEM			512
#endif /* DHD_IOTLTPUT_TUNABLES */
...
#elif defined(DHD_IOTLTPUT_TUNABLES)
#define H2DRING_RXPOST_MAX_ITEM			256
#define D2HRING_TXCMPLT_MAX_ITEM		512
