...
/* Force the NUM_EVENT_LOG_SETS as 0 if chip no EVENT log support */
#if defined(BCM43456_CHIP)
#ifdef NUM_EVENT_LOG_SETS
#undef NUM_EVENT_LOG_SETS
#endif /* NUM_EVENT_LOG_SETS */
#define NUM_EVENT_LOG_SETS 0
#endif /* Chips have no EVENT log */
