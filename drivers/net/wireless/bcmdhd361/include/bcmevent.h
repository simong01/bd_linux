...
#define WLC_E_CSI		63	/* CSI reused obsoleted event number */
...
#define WLC_E_EXTRA_EVENT		119 /* Added for extra customer event */
...
#define WLC_E_CCD			129	/**< Channel Change Detect event */
#endif /* CSI_SUPPORT */
...
#define WLC_E_MWLC_E_SUP_PTK_UPDATELO_LINK_INFO		203	/* 11be MLO link information */
...
/* for extra event */
typedef enum wlc_extra_sub_event {
	WLC_E_EXTEVENT_RESERVED = 0,

	WLC_E_EXTEVENT_STA_ID_START = 0x00010000,
	WLC_E_EXTEVENT_STA_ID_RESERVED,
	WLC_E_EXTEVENT_STA_ID_END,

	WLC_E_EXTEVENT_AP_ID_START = 0x00020000,
	WLC_E_EXTEVENT_AP_EXTSTA_AUTHORIZED,
	WLC_E_EXTEVENT_AP_EXTSTA_DEAUTHORIZED,
	WLC_E_EXTEVENT_AP_RXFRAG_POOL_EMPTY,
	/* for DFS related */
	WLC_E_EXTEVENT_AP_DFS_RADAR,
	WLC_E_EXTEVENT_AP_DFS_AP_START,
	WLC_E_EXTEVENT_AP_DFS_AP_STOP,
	WLC_E_EXTEVENT_AP_DFS_CHANSPEC_OPEN,
	WLC_E_EXTEVENT_AP_DFS_CHANSPEC_CLOSE,
	WLC_E_EXTEVENT_AP_DFS_STATE_CHANGE,
	WLC_E_EXTEVENT_AP_ID_END,

	WLC_E_EXTEVENT_LAST
} wlc_extra_sub_event_t;
...
#define WLC_E_REASON_REASSOC		19	/* roamed due to reassoc iovar (legacy device) */
...
#define WLC_E_SUP_MSG3_NO_MLO_GTK	25	/* NOTE: this is deprecated */
#define WLC_E_SUP_NO_MLO_GTK		25	/* Encapsulated MLO GTK missing */
#define WLC_E_SUP_NO_IGTK		26	/* Encapsulated IGTK missing */
#define WLC_E_SUP_NO_BIGTK		27	/* Encapsulated BIGTK missing */
#define WLC_E_SUP_NO_MLO_IGTK		28	/* Encapsulated MLO IGTK missing */
#define WLC_E_SUP_NO_MLO_BIGTK		29	/* Encapsulated MLO BIGTK missing */
#define WLC_E_SUP_IGTK_DECRYPT_FAIL	30	/* IGTK decrypt failure */
#define WLC_E_SUP_IGTK_UPDATE_FAIL	31	/* IGTK update failure */
#define WLC_E_SUP_BIGTK_DECRYPT_FAIL	32	/* BIGTK decrypt failure */
#define WLC_E_SUP_BIGTK_UPDATE_FAIL	33	/* BIGTK update failure */
#define WLC_E_SUP_GTK_BAD_KEY_IDX	34	/* Bad GTK key index */
#define WLC_E_SUP_IGTK_BAD_KEY_IDX	35	/* Bad IGTK key index */
#define WLC_E_SUP_BIGTK_BAD_KEY_IDX	36	/* Bad BIGTK key index */
#define WLC_E_SUP_BCN_PROT_DISABLED_AP	37	/* Beacon Protection is disabled in the AP */
#define WLC_E_SUP_GTK_BAD_LINK_ID	38	/* Bad GTK link id */
#define WLC_E_SUP_IGTK_BAD_LINK_ID	39	/* Bad IGTK link id */
#define WLC_E_SUP_BIGTK_BAD_LINK_ID	40	/* Bad BIGTK link id */
#define WLC_E_SUP_FT_ELEM_CNT_MISMATCH	41	/* Element cnt mismatch with num of elem in FTIE */
#define WLC_E_SUP_M4_TX_NOACK		42	/* No ack to M4 TX */
...
#ifdef CSI_SUPPORT
typedef struct wl_event_ccd {
	uint32	version; /**< Unused */
	uint32	length;  /**< Unused */
	uint32	status; /**< Not 0 -> detected */
	float	value;	/**< Value that crossed detection thres. */
} wl_event_ccd_t;
#endif /* CSI_SUPPORT */
