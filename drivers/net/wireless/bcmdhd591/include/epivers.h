...
#define EPI_COMMIT_ID		"(2-ge3d8990)"

/* Driver Version String, ASCII, 32 chars max */
#if defined (WLTEST)
#define EPI_VERSION_STR		"101.10.591.112 (WLTEST)"
#elif (defined (BCMDBG_ASSERT) && !defined (BCMDBG_ASSERT_DISABLED))
#define EPI_VERSION_STR		"101.10.591.112 (ASSRT)"
#else
#define EPI_VERSION_STR		"101.10.591.112"
#endif /* BCMINTERNAL */
