...
#define APCS_MAX_CHANNEL_QUANTITY		256
...
extern int init_roam_cache(struct bcm_cfg80211 *cfg, int ioctl_ver);
extern void print_roam_cache(struct bcm_cfg80211 *cfg);
