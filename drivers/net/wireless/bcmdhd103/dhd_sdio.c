...
#ifdef DHD_DEBUG_DOWNLOADTIME
	DHD_PRINT(("Firmware download time for %u bytes: %u ms\n",
...
#endif /* defined(SUPPORT_MULTIPLE_CHIPS) && defined(CUSTOMER_HW4) */
