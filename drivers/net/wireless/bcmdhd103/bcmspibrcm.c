...
#else
/* Some SPI host controller changes endianness when writing/reading
...
*/
	...
	{
		/* Should copy for alignment reasons */
...
sdioh_cis_read(sdioh_info_t *sd, uint func, uint8 *cisd, uint32 length)
{
	...
	offset =  CC_REG_OFF(sromotp); /* OTP offset in chipcommon. */
...
/* What is clock rate at high and low speeds ? */
static int
...
#define CTRL_REG_DEFAULT	0x00010430 /* according to the host m/c */
		...
		/* With intr-polarity active-high, host platform does not go into suspend mode
