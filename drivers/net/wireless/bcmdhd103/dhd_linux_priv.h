 ...
 */
#if ((defined(BOARD_HIKEY) || defined(BOARD_STB)) && (LINUX_VERSION_CODE >= \
	KERNEL_VERSION(4, 19, 96))) || (defined(CONFIG_ARCH_MSM) && (((LINUX_VERSION_CODE >= \
	KERNEL_VERSION(4, 14, 170)) && (LINUX_VERSION_CODE < KERNEL_VERSION(4, 15, 0))) || \
