...
typedef enum {
	...
	/* define all mdns offload related commands between 0x2180 and 0x218F */
	ANDROID_NL80211_SUBCMD_MDNS_OFFLOAD_START = 0x2180,
	ANDROID_NL80211_SUBCMD_MDNS_OFFLOAD_END = 0x218F,
...
enum andr_vendor_subcmd {
	...
	MDNS_OFFLOAD_SUBCMD_SET_STATE = ANDROID_NL80211_SUBCMD_MDNS_OFFLOAD_START,
	MDNS_OFFLOAD_SUBCMD_RESET_ALL,
	MDNS_OFFLOAD_SUBCMD_ADD_RESPONSES,
	MDNS_OFFLOAD_SUBCMD_REMOVE_RESPONSES,
	MDNS_OFFLOAD_SUBCMD_GET_HIT_COUNTER,
	MDNS_OFFLOAD_SUBCMD_GET_MISS_COUNTER,
	MDNS_OFFLOAD_SUBCMD_ADD_TO_PASSTHROUGH,
	MDNS_OFFLOAD_SUBCMD_REMOVE_FROM_PASSTHROUGH,
	MDNS_OFFLOAD_SUBCMD_SET_PASSTHROUGH_BEHAVIOR,
...
typedef enum {
	MDNS_OFFLOAD_ATTR_INVALID = 0,
	MDNS_OFFLOAD_ATTR_ENABLED,		/* u8 */
	MDNS_OFFLOAD_ATTR_RECORD_KEY,		/* u32 */
	MDNS_OFFLOAD_ATTR_PROTOCOL_DATA,	/* binary */
	MDNS_OFFLOAD_ATTR_MATCH_CRITERIA,
	MDNS_OFFLOAD_ATTR_QNAME,		/* string */
	MDNS_OFFLOAD_ATTR_PASSTHROUGH_BEHAVIOR,	/* u8 */
	MDNS_OFFLOAD_ATTR_RETURN_VALUE,		/* u32 (return only) */
	MDNS_OFFLOAD_ATTR_MAX
} MDNS_OFFLOAD_ATTRIBUTE;
