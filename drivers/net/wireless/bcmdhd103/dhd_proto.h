...
extern uint32 dhd_prot_scale_factor(dhd_pub_t *dhd, bool set, uint32 val);
extern uint32 dhd_prot_txdur_scale(dhd_pub_t *dhd, bool set, uint32 val);
extern uint32 dhd_prot_rxdur_scale(dhd_pub_t *dhd, bool set, uint32 val);
#endif
