...
#define SCANOL_ENABLED			(1 << 0u)
#define SCANOL_BCAST_SSID		(1 << 1u)
#define SCANOL_NOTIFY_BCAST_SSID	(1 << 2u)
#define SCANOL_RESULTS_PER_CYCLE	(1 << 3u)
...
/* First two uint16 are version and length fields. So offset of the first counter will be 4 */
...
enum wl_ifstats_xtlv_id {
	...
	WL_IFSTATS_XTLV_IF_PEER_STATS = 0x50E,

	WL_IFSTATS_XTLV_ACTION = 0x50F,
	WL_IFSTATS_XTLV_RXTB = 0x510,

	WL_IFSTATS_XTLV_EHT_TXSU = 0x511,
	WL_IFSTATS_XTLV_EHT_RXSU = 0x512,
	WL_IFSTATS_XTLV_EHT_DLMUMIMO = 0x513,
	WL_IFSTATS_XTLV_EHT_DLOFDMA = 0x514,
	WL_IFSTATS_XTLV_EHT_ULOFDMA = 0x515,

	WL_IFSTATS_XTLV_UHR_TXSU = 0x516,
	WL_IFSTATS_XTLV_UHR_RXSU = 0x517,
	WL_IFSTATS_XTLV_UHR_DLMUMIMO = 0x518,
	WL_IFSTATS_XTLV_UHR_DLOFDMA = 0x519,
	WL_IFSTATS_XTLV_UHR_ULOFDMA = 0x51A,

	WL_IFSTATS_XTLV_HE_TXSU = 0x51B,
	WL_IFSTATS_XTLV_HE_RXSU = 0x51C,
	/* HE DL/UL OFDMA, DL MUMIMO are not reported separately in ecounters.
	 * They are availbale as part of EHT/UHR stats
	 */
