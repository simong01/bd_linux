 ...
 * Code generated by Cursor - Claude4 sonnet
 */
...
#define EVENT_LOG_MAX_BLOCK_SIZE	1932
#else
...
/* Invalid index for priority delivery */
#define EVENT_LOG_SET_INVALID	0xFF

/* Event log set delivery priorities */
typedef enum {
	EVENT_LOG_SET_DELIVERY_PRIO_RSVD = 0,          /* Reserved */
	EVENT_LOG_SET_DELIVERY_PRIO_HIGHEST = 1,       /* Highest priority */
	EVENT_LOG_SET_DELIVERY_PRIO_HIGH = 2,          /* High priority */
	EVENT_LOG_SET_DELIVERY_PRIO_MEDIUM = 3,        /* Medium priority */
	EVENT_LOG_SET_DELIVERY_PRIO_LOW = 4,           /* Low priority */
	EVENT_LOG_SET_DELIVERY_PRIO_MAX                /* Maximum value */
} event_log_set_delivery_priority_t;
...
typedef struct event_log_top_v1 {
	...
	uint8 curr_delv_index;
	uint8 PAD[3];
	uint8 *delivery_priority_arr;  /* Base pointer to allocated priority array memory */
	uint8 *delv_priority_array_sizes;  /* Pointer to priority array sizes */
	uint8 **set_delivery_priority;  /* Pointer to array of delivery priority arrays */
} event_log_top_v1_t;
...
typedef struct event_log_set_init_config_entry {
	...
	event_log_set_delivery_priority_t delivery_priority;  /* Delivery priority */
	bool init_priority_only;  /* If TRUE, only set priority, don't initialize set */
...
#ifdef EVENT_LOG_SET_DELV_PRIO
#define EVENT_LOG_DELIVERY_PRIORITY_SET(set, prio)	event_log_delivery_priority_set(set, prio)
#else
#define EVENT_LOG_DELIVERY_PRIORITY_SET(set, prio)	BCME_OK
#endif /* EVENT_LOG_SET_DELV_PRIO */
...
/* Priority-based delivery APIs */
extern int event_log_get_next_priority_set(int *set_num);
extern int event_log_delivery_priority_set(uint8 set_num,
	event_log_set_delivery_priority_t priority);
