...
/* Shadow registers */
#define PCIE_SR_BASE	(0x18003800) /* XXX */
#define PCIE_SR_DEVID	(PCIE_SR_BASE + (2 * 0x60))
/* BAR1 Control, Power Management Capability) */
#define PCIE_SR_PMC	(PCIE_SR_BASE + (2 * 0x64))
#define PCIE_SR_PMC_BAR1_EN		(1 << 0)
#define PCIE_SR_PMC_BAR1_SZ		(0x2 << 1) /* 4MB */
#define PCIE_SR_PMC_PME_EN		(1 << 4)
#define PCIE_SR_PMC_PME_D0		(1 << 5)
#define PCIE_SR_PMC_PME_D1		(1 << 6)
#define PCIE_SR_PMC_PME_D2		(1 << 7)
#define PCIE_SR_PMC_PME_D3Hot		(1 << 8)
#define PCIE_SR_PMC_PME_D3Cold		(1 << 9)
#define PCIE_SR_PMC_PME_D3Cold_Vaux	(1 << 10)
#define PCIE_SR_PMC_CPM_EN		(1 << 11)
#define PCIE_SR_PMC_BARO_TR		(3 << 12)
#define PCIE_SR_PMC_DEFAULT_VAL (\
	PCIE_SR_PMC_BAR1_EN	| \
	PCIE_SR_PMC_BAR1_SZ	| \
	PCIE_SR_PMC_PME_EN	| \
	PCIE_SR_PMC_PME_D0	| \
	PCIE_SR_PMC_PME_D1	| \
	PCIE_SR_PMC_PME_D2	| \
	PCIE_SR_PMC_PME_D3Hot	| \
	PCIE_SR_PMC_PME_D3Cold	| \
	PCIE_SR_PMC_PME_D3Cold_Vaux |\
	PCIE_SR_PMC_CPM_EN	| \
	PCIE_SR_PMC_BARO_TR)
#endif	/* _h_pcicfg_ */
